  ...
  return (
    <div className="mt-7 mb-5 flex flex-col md:flex-row justify-between items-center">
      ...
      <div className="flex gap-8">
        <a href="/home" className="font-semibold text-lg hover:text-[#6047EC]">
          Home
        </a>
        <a href="/blog" className="font-semibold text-lg hover:text-[#6047EC]">
          Blog
        </a>
        <a
          href="/contact"
          className="font-semibold text-lg hover:text-[#6047EC]"
        >
          Contact
        </a>
      </div>
